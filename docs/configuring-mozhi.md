...
This is an [Ansible](https://www.ansible.com/) role which installs [Mozhi](https://github.com/httpjamesm/Mozhi) to run as a [Docker](https://www.docker.com/) container wrapped in a systemd service.
...
See its [`docker-compose.example.yml`](https://github.com/httpjamesm/Mozhi/blob/main/docker-compose.example.yml) for a complete list of Mozhi's config options that you could put in `mozhi_environment_variables_additional_variables`.
